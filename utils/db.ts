...
const db = {
    skill: {
        ...
        update: async (id: number, payload: any) => prisma.skill.update({ where: { id }, data: skillSchema.partial().parse(payload) }),
    ...
    project: {
        ...
        update: async (id: number, payload: any) => prisma.project.update({ where: { id }, data: projectSchema.partial().parse(payload) }),
    ...
    experience: {
        ...
        update: async (id: number, payload: any) => prisma.experience.update({ where: { id }, data: experienceSchema.partial().parse(payload) }),
    ...
    testimonial: {
        ...
        update: async (id: number, payload: any) => prisma.testimonial.update({ where: { id }, data: testimonialSchema.partial().parse(payload) }),
    ...
    blog: {
        ...
        update: async (id: number, payload: any) => prisma.blog.update({ where: { id }, data: blogSchema.partial().parse(payload) }),
    ...
    comment: {
        ...
        update: async (id: number, payload: any) => prisma.comment.update({ where: { id }, data: commentSchema.partial().parse(payload) }),
    ...
    setting: {
        ...
        update: async (id: number, payload: any) => prisma.setting.update({ where: { id }, data: settingSchema.partial().parse(payload) }),
    ...
    education: {
        ...
        update: async (id: number, payload: any) => prisma.education.update({ where: { id }, data: educationSchema.partial().parse(payload) }),
    ...
    resume: {
        ...
        update: async (id: number, payload: any) => prisma.resume.update({ where: { id }, data: resumeSchema.partial().parse(payload) }),
